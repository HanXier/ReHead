 ...
 */
public class NotificationService extends AppCompatActivity implements LoaderCallbacks <Cursor> {
    ...
    private void addEmailsToAutoComplete(List <String> emailAddressCollection) {
        ...
        ArrayAdapter <String> adapter = new ArrayAdapter <>(NotificationService.this, android.R.layout.simple_dropdown_item_1line, emailAddressCollection);
